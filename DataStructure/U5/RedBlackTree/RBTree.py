...
class RBTree(object):
    ...
    def inOrder(n):
        if(n == T.nil):
            return None
        return inOrder(n.left) + (n.key, n.color) + inOrder(n.right)
...
def main():
    ...
    tree.RBInsert(n1)
    """
    tree.RBInsert(tree, RBTreeNode(12))
    tree.RBInsert(tree, RBTreeNode(4))
    tree.RBInsert(tree, RBTreeNode(5))
    tree.RBInsert(tree, RBTreeNode(6))
    tree.RBInsert(tree, RBTreeNode(3))
    """
    tree.inOrder()
